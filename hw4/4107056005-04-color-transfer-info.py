# USAGE
# python 4107056005-04-color-transfer-info.py --source sou1.bmp --target tar1.bmp
...
#   因為原程式的src tar與我們相反
   with open('sideinfodeci.txt','w') as f:
      f.write(str(round(lMeanTar,4))+'\n')
      f.write(str(round(aMeanTar,4))+'\n')
      f.write(str(round(bMeanTar,4))+'\n')
      f.write(str(round(lStdTar,4))+'\n')
      f.write(str(round(aStdTar,4))+'\n')
      f.write(str(round(bStdTar,4))+'\n')
      f.write(str(round(lMeanSrc,4))+'\n')
      f.write(str(round(aMeanSrc,4))+'\n')
      f.write(str(round(bMeanSrc,4))+'\n')
      f.write(str(round(lStdSrc,4))+'\n')
      f.write(str(round(aStdSrc,4))+'\n')
      f.write(str(round(bStdSrc,4))+'\n')
...
# save image
# for i in range(5,7):
# 	source = cv2.imread("sou"+str(i)+"-self.bmp")
# 	target = cv2.imread("tar"+str(i)+"-self.bmp")
# 	transfer = color_transfer(target, source, clip=args["clip"], preserve_paper=args["preservePaper"])
# 	cv2.imwrite("ult{}-self.bmp".format(i), transfer)